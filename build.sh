...
wso2_product_plugin_path=`cd ${script_path}/prod-plugins/; pwd`
...
if [ -f ${script_path}/scripts/build-helper.sh ]; then
    source ${script_path}/scripts/build-helper.sh
else
...
if [ -d ${script_path}/plugins/ ]; then
    common_plugin_path=`cd ${script_path}/plugins/; pwd`
else
